...
angular.module('particleApp', ['lucidComponents', 'ngDraggable', 'ngSortable', 'dndLists'])
    ...
    .controller('mainCtrl', function($scope, $timeout, $rootScope) {
        ...
        $scope.templates = [
            {name:'Flowchart', diagram: 'Flowchart',  category: 'Business', preview:'images/group10.png', recommended: 'true'},
            {name:'Venn Diagram', diagram: 'Flowchart', category: 'Business', preview:'images/group8.png', recommended: 'true'},
            {name:'Table', diagram: 'Flowchart', category: 'Business', preview:'images/group9.png', recommended: 'false'},
