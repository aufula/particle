    ...
    .controller('mainCtrl', function($scope, $timeout, $rootScope) {
        ...
        /// Start function for showing the different tabs and buttons around template manager
           $scope.getNext = function(){
            ...
            if($scope.showFieldSection == true){
                ...
                $scope.templates = [
                    {name:'Android Mockups', preview:'images/1.png', recommended: 'false'},
                    {name:'AWS Architecture', preview:'images/2.png', recommended: 'false'},
                    {name:'Azure', preview:'images/3.png', recommended: 'false'},
                    {name:'BPMN 2.0', preview:'images/4.png', recommended: 'false'},
                    {name:'Circuit Diagrams', preview:'images/5.png', recommended: 'false'},
                    {name:'Cisco Network', preview:'images/6.png', recommended: 'false'},
                    {name:'Data Flow', preview:'images/7.png', recommended: 'false'},
                    {name:'Enterprise Integration', preview:'images/8.png', recommended: 'false'},
                    {name:'Entity Relationship', preview:'images/9.png', recommended: 'false'},
                    {name:'Equations', preview:'images/1.png', recommended: 'false'},
                    {name:'Flowchart', preview:'images/2.png', recommended: 'false'},
                    {name:'iOS Mockups', preview:'images/3.png', recommended: 'false'},
                    {name:'Mind Mapping', preview:'images/4.png', recommended: 'false'},
                    {name:'Network Infrastructure', preview:'images/5.png', recommended: 'false'},
                    {name:'Org Charts', preview:'images/6.png', recommended: 'false'},
                    {name:'Process Engineering', preview:'images/7.png', recommended: 'false'},
                    {name:'Server Rack Diagrams', preview:'images/8.png', recommended: 'false'},
                    {name:'Site Maps', preview:'images/9.png', recommended: 'false'},
                    {name:'Tables', preview:'images/1.png', recommended: 'false'},
                    {name:'Timeline', preview:'images/2.png', recommended: 'false'},
                    {name:'Tech Clipart', preview:'images/3.png', recommended: 'false'},
                    {name:'UI Mockups', preview:'images/4.png', recommended: 'false'},
                    {name:'UML', preview:'images/5.png', recommended: 'false'},
                    {name:'Value Stream', preview:'images/6.png', recommended: 'false'},
                    {name:'Venn Diagrams', preview:'images/7.png', recommended: 'false'},
                    {name:'Video', preview:'images/8.png', recommended: 'false'},        
                ];
        ...
        $scope.getDiagrams = function(string1, string2){
            ...
            if(string2=='design'){
                ...
                $scope.templates = [
                    {name:'Android Mockups', preview:'images/1.png', recommended: 'true'},
                    {name:'Flowchart', preview:'images/2.png', recommended: 'true'},
                    {name:'iOS Mockups', preview:'images/3.png', recommended: 'true'},
                    {name:'UI Mockups', preview:'images/4.png', recommended: 'true'},
                    {name:'Tech Clipart', preview:'images/3.png', recommended: 'true'},
                    {name:'AWS Architecture', preview:'images/2.png', recommended: 'false'},
                    {name:'Azure', preview:'images/3.png', recommended: 'false'},
                    {name:'BPMN 2.0', preview:'images/4.png', recommended: 'false'},
                    {name:'Circuit Diagrams', preview:'images/5.png', recommended: 'false'},
                ...
                $scope.templates = [
                    {name:'Data Flow', preview:'images/7.png', recommended: 'true'},
                    {name:'Flowchart', preview:'images/2.png', recommended: 'true'},
                    {name:'Mind Mapping', preview:'images/4.png', recommended: 'true'},
                    {name:'Tables', preview:'images/1.png', recommended: 'true'},
                    {name:'Venn Diagrams', preview:'images/7.png', recommended: 'true'},
                    {name:'Android Mockups', preview:'images/1.png', recommended: 'false'},
                    {name:'AWS Architecture', preview:'images/2.png', recommended: 'false'},
                    {name:'Azure', preview:'images/3.png', recommended: 'false'},
                    {name:'BPMN 2.0', preview:'images/4.png', recommended: 'false'},
                ...
                $scope.templates = [
                    {name:'AWS Architecture', preview:'images/2.png', recommended: 'true'},
                    {name:'Circuit Diagrams', preview:'images/5.png', recommended: 'true'},
                    {name:'Cisco Network', preview:'images/6.png', recommended: 'true'},
                    {name:'Android Mockups', preview:'images/1.png', recommended: 'false'},
                    {name:'Azure', preview:'images/3.png', recommended: 'false'},
                    {name:'BPMN 2.0', preview:'images/4.png', recommended: 'false'},
                    {name:'Data Flow', preview:'images/7.png', recommended: 'false'},
